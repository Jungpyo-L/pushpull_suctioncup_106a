...
# adaptHelp = adaptMotionHelp(d_lat=0.005, dw=0.5, d_z=0.0010) #lateral --> align --> normal = sliding right --> rolling --> moving down
  ...
  # Set the pose A
  # positionA = [0.48383, -0.02173, 0.07231]  # yes
  positionA = [0.48143, -0.02173, 0.07231]  # yes
...
if __name__ == '__main__':
  ...
  parser.add_argument('--deformation', type=float, default=2.0, help='Deformation (mm) to apply downward before grasp')
